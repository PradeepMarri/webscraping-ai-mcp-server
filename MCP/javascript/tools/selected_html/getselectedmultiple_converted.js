...
export async function get_selected_multiple(url, wait_for, proxy, country, custom_proxy, device, js_script, timeout, js_timeout, js, error_on_404, error_on_redirect, headers, selectors) {
  try {
    ...
    const params = new URLSearchParams();
      ...
      if (selectors) params.append("selectors", selectors);
...
export function createGetSelectedMultipleTool() {
  return {
    definition: {
      name: 'get-selected-multiple',
