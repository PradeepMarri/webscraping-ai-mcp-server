...
export async function get_ai_fields(url, wait_for, proxy, country, custom_proxy, device, js_script, timeout, js_timeout, js, error_on_404, error_on_redirect, fields, headers) {
  try {
...
export function createGetAiFieldsTool() {
  return {
    definition: {
      name: 'get-ai-fields',
